...
import { testFileUrl } from "../url";

import s from "./AnimalsUa.module.css";
import { useRef } from "react";
import Steps from "../../../../components/Steps/Steps";
import AnimalsUaForm from "./AnimalsUaForm/AnimalsUaForm";
const AnimalsUa = () => {
  ...
  return (
    <div className={s.header}>
      ...
      <section ref={formRef} className={s.formsection}>
        <AnimalsUaForm url={testFileUrl} />
      </section>
    </div>
  );
};

export default AnimalsUa;
